...
<div class="flex flex-col gap-2">
    <div class="text-2xl font-bold">{{ __('checklists_checklistadminchildren.BATCH_PARSE_SP_LIST') }}</div>
    <hr />
    ...
    <form class="flex flex-col gap-4">
        ...
        <x-checkbox
            id="parentclid"
            :label="__('checklists_checklistadminchildren.COPYPERMISSIONANDGENERAL')"
        ...
        <x-link
            ...
            >{{ __('checklists_checklistadminchildren.OPEN_TAX_THES_EXPLORE') }}</x-link
        >
    </form>
</div>
