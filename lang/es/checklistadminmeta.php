...
return [
    ...
    'NEED_LAT' => 'Si la longitud tiene un valor, la latitud también debe tenerlo',
    'LONG_NUMERIC' => 'La longitud debe ser estrictamente numérica (formato decimal: p.e. -112.2343)',
    'NO_ONE_EIGHTY' => 'Los valores de longitud no pueden ser mayores que 180 o menores que -180',
    'NUMERIC_RADIUS' => 'El radio del punto debe ser un valor numérico únicamente',
    'NEED_STATE' => 'Los listados de especies raras deben tener un estado, provincia, o departamento ingresado en el campo de localidad',
