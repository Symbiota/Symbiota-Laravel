        ...
        return {
            ...
            annotationTypeChanged() {
                ...
                if (this.annotationType === 'na') {
                    ...
                    form.dateidentified.value = new Date().toISOString().slice(0, 10);
                } else {
    ...
    <div x-data="batchDeterminations(@js($batchDeterminationConfig))">
        ...
        <div class="space-y-6">
            <div>
                ...
                <h2 class="text-2xl ">{{ $collectionName }}</h2>
            </div>
        ...
        <section x-show="records.length" x-cloak class="space-y-4">
            ...
            >
                ...
                <div class="flex items-center gap-2">
                    ...
                    />
                    <label class="font-bold" for="accselectall">{{ __('editor_batchdeterminations.SELECT_DESELECT') }}</label>
                </div>
                        ...
                        <div class="flex max-w-2xl flex-wrap items-center gap-2">
                            ...
                            <div class="min-w-80 flex-1">
                                <x-autocomplete-input
                                    ...
                                    request_config='{"alias":{"sciname":"taxa"}}'
                                >
                                    <x-slot name="input" @auto_input_select="verifyDetSciName()" class="w-full"></x-slot>
                                    <x-slot name="menu"></x-slot>
                                </x-autocomplete-input>
                            </div>
