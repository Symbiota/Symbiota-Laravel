@pushOnce('js-scripts')
    <script type="text/javascript">
        ...
        function add_marker(latlng) {
            ...
            if (error_radius) {
                const circ = L.circle(latlng, error_radius)
                    .on("click", () => {
...
<x-layout class="p-0" :hasHeader="false" :hasNavbar="false" :hasFooter="false">
    <div class="p-4">
        <div class="mb-4 flex items-center gap-4">
            <p>Click once to capture coordinates. Click on the Submit button to transfer Coordinates. Enter uncertainty to create an error radius circle around the marker</p>
