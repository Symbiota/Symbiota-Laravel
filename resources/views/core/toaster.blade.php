        ...
        <ul
            ...
            <template x-for="(toast, index) in toasts" :key="toast.id">
                <li
                    ...
                    >
                    <span
                        class="relative flex flex-col items-start shadow-[0_5px_15px_-3px_rgb(0_0_0_/_0.08)] w-full transition-all duration-300 ease-out bg-white border border-base-300 sm:rounded-md sm:max-w-xs group"
                        :class="{ 'p-4' : !toast.html, 'p-0' : toast.html }"
                    >
                        <template x-if="!toast.html">
                            <div class="relative">
                                <div class="flex items-center"
                                    :class="{ 'text-success' : toast.type=='success', 'text-info' : toast.type=='info', 'text-warning' : toast.type=='warning', 'text-error' : toast.type=='danger', 'text-base-content' : toast.type=='default' }">
                                    ...
                                    <p class="text-[13px] font-medium leading-none text-base-content" x-text="toast.message"></p>
                                </div>
                        ...
                        <span
                            ...
                            class="absolute right-0 p-1.5 mr-2.5 text-base-content/50 duration-100 ease-in-out rounded-full opacity-0 cursor-pointer hover:bg-base-200 hover:text-base-content"
