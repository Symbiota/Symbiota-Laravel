...
class DarwinCoreDownloadTest extends TestCase {
     ...
     */
    public function test_occid(): void { self::check_mapping(['occid' => 1], ['id' => 1]); }
     ...
     */
    public function test_references(): void { self::check_mapping(['occid' => 1], ['id' => 1, 'references' => '/occurrence/1']); }
