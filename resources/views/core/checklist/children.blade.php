...
<div class="flex flex-col gap-2">
    <div class="flex">
        <span class="font-bold text-2xl">
           {{ __('checklists_checklistadminchildren.CHILD_CHECKLIST') }}
        </span>
            ...
            <x-modal>
                ...
                <x-slot name="body">
                    <form method="post" class="flex flex-col gap-4">
                        ...
                        <input type="hidden" name="submitaction" value="addChildChecklist" aria-label="{{ __('checklists_checklistadminchildren.ADD_CHILD') }}" />
