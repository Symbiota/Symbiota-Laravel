@props(['variant' => 'primary', 'href', 'disabled' => false])
@php
...
$base = 'rounded-lg shadow-xl focus:ring-4 hover:ring-4 hover:ring-accent focus:ring-accent focus:outline-none text-base font-bold flex items-center gap-1 py-1 px-2.5 h-fit w-fit cursor-pointer';
$tag = 'button';
