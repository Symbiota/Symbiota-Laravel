            ...
            <div>
                <section class="bg-base-100 rounded border p-4">
                    <h2 class="text-lg font-bold">
                        {{ ($collid ? 'Edit' : 'Add New') . ' ' . __('misc_collmetadata.COL_INFO') }}
                    </h2>
                    ...
                    >
                        ...
                        <div class="{{ $fieldRowClass }}">
                            ...
                            <div class="flex max-w-full flex-wrap items-start gap-2">
                                ...
                                <x-popover class="w-[28rem] text-sm">
                                    ...
                                    <div class="text-base-content">
                                        {!! Purify::clean(__('misc_collmetadata.EXPLAIN_PUBLIC')) !!}
                                    </div>
                                </x-popover>
                            </div>
                        </div>
                                ...
                                @if($rightsTerms)
                                    <select id="rights" name="rights" class="{{ $inputWideClass }}">
                                        @foreach($rightsTerms as $label => $value)
                                            <option value="{{ $value }}" @selected($rightsValue === $value)
                                                >{{ $label }}
                                            </option>
                                        @endforeach
                            ...
                            <div class="{{ $fieldRowClass }}">
                                ...
                                <div class="flex max-w-full flex-wrap items-start gap-2">
                                    ...
                                    >
                                        ...
                                        <option
                                            value="Preserved Specimens"
                                            @selected($collType === 'Preserved Specimens')
                                        ...
                                        <option
                                            value="General Observations"
                                            @selected($collType === 'General Observations')
                                    ...
                                    <x-popover class="w-[28rem] text-sm">
                                        ...
                                        <div class="text-base-content">
                                            {!! Purify::clean(__('misc_collmetadata.COL_TYPE_DEF')) !!}
                                        </div>
                                    </x-popover>
                            ...
                            <div class="bg-base-200 my-3 rounded border p-4">
                                <div class="flex items-start gap-1">
                                    ...
                                    <x-popover class="w-[28rem] text-sm">
                                        ...
                                        <div class="text-base-content">
                                            {!! Purify::clean(__('misc_collmetadata.SNAPSHOT_DEF')) !!}
                                        </div>
                                    </x-popover>
                                </div>
                                <div class="mt-2">
                        ...
                        <div class="{{ $fieldRowClass }}" x-data="{ iconMode: '{{ $iconMode }}' }">
                            ...
                            <div class="flex max-w-full flex-wrap items-start gap-2">
                                ...
                                <x-popover class="w-[28rem] text-sm">
                                    ...
                                    <div class="text-base-content">
                                        {!! Purify::clean(__('misc_collmetadata.UPLOAD_ICON')) !!}
                                    </div>
                                </x-popover>
                        ...
                        @if($collid)
                            <div class="{{ $fieldRowClass }}">
                                ...
                                <div class="text-base-content/70 min-h-9 max-w-full">
                                    {{ $collection['securitykey'] ?? '' }}
                                </div>
                            </div>
                            <div class="{{ $fieldRowClass }}">
                                ...
                                @foreach($resourceLinks as $index => $link)
                                    <div class="{{ $loop->first ? '' : 'border-t  pt-3' }}">
                                        <div class="flex flex-wrap items-center gap-3">
                                            ...
                                            >
                                                <i
                                                    class="fas fa-trash text-base-content hover:text-base-content/50"
                                                ></i>
                                            </button>
                                        </div>
