...
class CollectionStats extends Model {
    ...
    public function specimen() {
        return $this->extra('SpecimensCountID');
    }

    public function genbank() {
        return $this->extra('gencnt');
    }

    public function other_genetic() {
        return $this->extra('geneticcnt');
    }

    public function bold() {
        return $this->extra('boldcnt');
    }

    public function references() {
        return $this->extra('refcnt');
    }

    public function total_taxa() {
        return $this->extra('TotalTaxaCount');
    }

    public function recordcnt_percent(mixed $number): int {
        if ($this->recordcnt === 0 || ! is_numeric($number)) {
            return 0;
        }
