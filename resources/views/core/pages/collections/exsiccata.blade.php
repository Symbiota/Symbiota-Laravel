...
<x-margin-layout>
    ...
    <div class="exsiccata-page space-y-6">
        ...
        @if($unableLocateRecord)
            <div class="text-lg font-semibold">{{ __('exsiccati.UNABLE_LOCATE_REC') }}</div>
            {{--Index Page--}}
        @elseif(!$isDetailPage)
            <div class="flex items-start gap-6">
                <div x-data="{ toggleName: false }" class="min-w-0 flex-1">
                    <div class="flex items-center justify-between gap-4">
                        ...
                        @if($isEditor)
                            <button
                                ...
                                class="cursor-pointer px-3 py-2 leading-none font-bold"
                            >
                    ...
                    @if($isEditor)
                        <div x-cloak x-show="toggleName" id="exsadddiv" class="mt-3 max-w-xl rounded border p-3">
                            <form
                                method="POST"
                                action="{{ $postAction }}"
                                onsubmit="return verifyExsAddForm(this);"
                                class="space-y-2"
                            >
                                @csrf
                                <div>
                                    <label
                                        ...
                                        >{{ __('exsiccati.TITLE') }}</label
                                    >
                                    <input
                                        id="title"
                                        name="title"
                                        type="text"
                                        class="mt-1 w-[90%] rounded border px-2 py-1.5"
                                    />
                                </div>
                                <div>
                                    <label
                                        for="abbreviation"
                                        class="block text-sm font-medium"
                                        >{{ __('exsiccati.ABB') }}</label
                                    >
                                    <input
                                        id="abbreviation"
                                        name="abbreviation"
                                        type="text"
                                        class="mt-1 w-full max-w-[480px] rounded border px-2 py-1.5"
                                    />
                                </div>
                                <div>
                                    <label
                                        for="editor"
                                        class="block text-sm font-medium"
                                        >{{ __('exsiccati.EDITOR') }}</label
                                    >
                                    <input
                                        id="editor"
                                        name="editor"
                                        type="text"
                                        class="mt-1 w-full max-w-[300px] rounded border px-2 py-1.5"
                                    />
                                </div>
                                <div class="grid gap-2 sm:grid-cols-2">
                                    <div>
                                        <label
                                            for="exsrange"
                                            class="block text-sm font-medium"
                                            >{{ __('exsiccati.NUM_RANGE') }}</label
                                        >
                                        <input
                                            id="exsrange"
                                            name="exsrange"
                                            type="text"
                                            class="mt-1 w-full max-w-[180px] rounded border px-2 py-1.5"
                                        />
                                    </div>
                                    <div>
                                        <label
                                ...
                                <div>
                                    ...
                                    <div class="mt-1 flex flex-wrap gap-2">
                                        <input
                                            name="startdate"
                                            type="text"
                                            class="w-full max-w-[180px] rounded border px-2 py-1.5"
                                        />
                                        <input
                                            name="enddate"
                                            type="text"
                                ...
                                <div>
                                    <label
                                        ...
                                        class="block text-sm font-medium"
                                        >{!! __('exsiccati.SOURCE_ID_INDEXS') !!}</label
                                    >
                                    <input
                                        id="sourceidentifier"
                    ...
                    <div class="mt-6">
                        ...
                        @if(empty($titles))
                            <div class="bg-base-100 px-4 py-6 text-lg">{{ __('exsiccati.NO_EXS_MATCHING') }}</div>
                        @else
                                ...
                                @foreach($titles as $titleId => $titleData)
                                    <li>
                                        <div>
                                            <a
                                                href="{{
route('exsiccata.index') . '?' . http_build_query(array_filter([
                                                'ometid' => $titleId,
                                                'searchterm' => $searchTerm,
                                                'specimenonly' => $specimenOnly,
                                                'imagesonly' => $imagesOnly,
                                                ...
                                                class="text-link-darker font-medium underline underline-offset-2"
                                            >
                                        ...
                                        @if(!empty($titleData['editor']) || !empty($titleData['exsrange']))
                                            <div class="text-base-content/50 ml-4 text-sm">
                ...
                <x-sticky-margin-container class="w-full max-w-[20rem] shrink-0 lg:ml-0 lg:h-auto lg:w-auto">
                    <form
                        method="GET"
                        action="{{ route('exsiccata.index') }}"
                        class="bg-base-200 relative z-10 w-full rounded border p-4"
                    >
                        <div class="space-y-4">
                            <div>
                                ...
                                <input
                                    ...
                                    name="searchterm"
                                    value="{{ $searchTerm }}"
                                    class="bg-base-100 mt-1 w-full rounded border px-3 py-2"
                                ...
                                <div class="space-y-4 pl-6">
                                    <div>
                                        ...
                                        <x-select
                                            ...
                                            :defaultValue="$collId ?: null"
                                            :onChange="'this.form.submit()'"
                                            :select_text="__('exsiccati.ALL_COLLS')"
                                        />
                                    </div>
        ...
        @elseif(! $isOccurrencePage)
                ...
                <div class="flex items-start justify-between gap-4">
                    <div>
                        ...
                        @if($indExsUrl)
                            <a
                                href="{{ $indExsUrl['url'] }}"
                                target="_blank"
                                class="text-link-darker mt-1 inline-block underline underline-offset-2"
                            >
                                {{ $indExsUrl['label'] }}
                            </a>
                        @endif
                    ...
                    @if($isEditor)
                        <div class="flex gap-2">
                            ...
                            <button
                                type="button"
                                @click="numAddOpen = !numAddOpen"
                                class="cursor-pointer px-3 py-2 text-lg leading-none font-bold"
                            >
                                <i class="fas fa-add text-base-content hover:text-base-content/50"></i>
                            </button>
                        </div>
                ...
                @if($isEditor)
                    <div x-cloak x-show="exsEditOpen" id="exseditdiv" class="space-y-4 rounded border p-4">
                        ...
                        >
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    type="text"
                                    value="{{ $title['title'] ?? '' }}"
                                    class="mt-1 w-[90%] rounded border px-3 py-2"
                                />
                            </div>
                            <div>
                                ...
                                <input
                                    ...
                                    class="mt-1 w-full max-w-[500px] rounded border px-3 py-2"
                                />
                            </div>
                            <div>
                                ...
                                <input
                                    ...
                                    type="text"
                                    value="{{ $title['editor'] ?? '' }}"
                                    class="mt-1 w-full max-w-[300px] rounded border px-3 py-2"
                                />
                            </div>
                            <div>
                                ...
                                <input
                                    name="exsrange"
                                    type="text"
                                    value="{{ $title['exsrange'] ?? '' }}"
                                    class="mt-1 w-full max-w-[180px] rounded border px-3 py-2"
                                />
                            </div>
                            <div>
                                ...
                                <div class="mt-1 flex flex-wrap gap-3">
                                    <input
                                        ...
                                        class="w-full max-w-[180px] rounded border px-3 py-2"
                                    />
                                    <input
                                        name="enddate"
                                        type="text"
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    type="text"
                                    value="{{ $title['source'] ?? '' }}"
                                    class="mt-1 w-full max-w-[480px] rounded border px-3 py-2"
                                />
                            </div>
                            <div>
                        ...
                        <form
                            method="POST"
                            action="{{ $postAction }}"
                            onsubmit="return window.confirm('{{ __('exsiccati.SURE_DELETE_EXS') }}');"
                        >
                            @csrf
                            <input type="hidden" name="ometid" value="{{ $currentOmetid }}" />
                            <x-button
                        ...
                        <form
                            method="POST"
                            action="{{ $postAction }}"
                            onsubmit="return verifyExsMergeForm(this);"
                            class="space-y-3"
                        >
                            @csrf
                            <input type="hidden" name="ometid" value="{{ $currentOmetid }}" />
                    ...
                    <div x-cloak x-show="numAddOpen" id="numadddiv" class="rounded border p-4">
                        <form
                            method="POST"
                            action="{{ $postAction }}"
                            onsubmit="return verifyNumAddForm(this);"
                            class="space-y-3"
                        >
                            @csrf
                            <input type="hidden" name="ometid" value="{{ $currentOmetid }}" />
            ...
            <hr class="border-accent-lighter border" />
            @if(empty($numbers))
                <div class="bg-base-100 text-lg font-semibold">{{ __('exsiccati.NO_EXS_NUMS') }}</div>
            @else
                <ul class="ml-6 list-disc space-y-2">
...
route('exsiccata.index') . '?' . http_build_query(array_filter([
                            ...
                            @if(!empty($numberData['notes']))
                                <div class="text-base-content/50 ml-4 text-sm">{{ $numberData['notes'] }}</div>
                            @endif
                        </li>
                    @endforeach
                </ul>
...
route('exsiccata.index') . '?' . http_build_query(array_filter([
                        ...
                        <div class="mt-2 space-y-1">
                            ...
                            @if($indExsUrl)
                                <a
                                    href="{{ $indExsUrl['url'] }}"
                                    target="_blank"
                                    class="text-link-darker inline-block underline underline-offset-2"
                                >
                                    {{ $indExsUrl['label'] }}
                                </a>
                            @endif
                ...
                @if($isEditor)
                    <div x-cloak x-show="numEditOpen" id="numeditdiv" class="space-y-4 border p-4">
                        <form
                            method="POST"
                            action="{{ $postAction }}"
                            onsubmit="return verifyNumAddForm(this);"
                        ...
                        <form
                            method="POST"
                            action="{{ $postAction }}"
                            onsubmit="return window.confirm('{{ __('exsiccati.SURE_DEL_EXS_NUM') }}');"
                        >
                            @csrf
                            <input type="hidden" name="ometid" value="{{ $currentOmetid }}" />
                            <input type="hidden" name="omenid" value="{{ $omenid }}" />
                    ...
                    <div x-cloak x-show="occAddOpen" id="occadddiv" class="rounded border p-4">
                        <form
                            method="POST"
                            action="{{ $postAction }}"
                            onsubmit="return verifyOccAddForm(this);"
                            class="space-y-3"
                        >
                            @csrf
                            <input type="hidden" name="ometid" value="{{ $currentOmetid }}" />
                            ...
                            <div>
                                ...
                                <x-select
                                    name="occaddcollid"
                                    class="mt-1 w-full max-w-[420px]"
                                    :items="$occAddCollectionItems"
                                    :select_text="__('exsiccati.SEL_COLL')"
                                />
                            </div>
                            <div class="grid gap-3 md:grid-cols-4">
                                ...
                                <div>
                                    ...
                                    <input
                                        name="recordedby"
                                        type="text"
                                        class="mt-1 w-full max-w-[220px] rounded border px-3 py-2"
                                    />
                                </div>
                                <div>
                                    <label class="block font-medium">{{ __('exsiccati.NUMBER') }}</label>
                            ...
                            <div>
                                ...
                                <input
                                    name="ranking"
                                    type="text"
                                    class="mt-1 w-full max-w-[120px] rounded border px-3 py-2"
                                />
                            </div>
                            <div>
                                <label class="block font-medium">{{ __('exsiccati.NOTES') }}</label>
            ...
            @if(empty($occurrences))
                <div class="bg-base-100 px-4 py-6 font-semibold">{{ __('exsiccati.NO_SPECS_WITH_EX_NUM') }}</div>
            @else
                <div class="mt-4">
                        ...
                        <div x-data="{ occEditOpen: false }">
                            <div class="flex flex-col gap-4 md:flex-row md:items-start md:justify-between">
                                <div class="space-y-1">
                                    ...
                                    @endif
                                    <div>
                                        {{ $occ['recby'] ?? '' }} {{ !empty($occ['recnum']) ? '#' . $occ['recnum'] : 's.n.' }}
                                ...
                                <div class="flex items-start gap-3">
                                    ...
                                    @if($isEditor)
                                        <button type="button" @click="occEditOpen = !occEditOpen" class="px-3 py-2">
                                            <i
                                                class="fas fa-edit text-base-content hover:text-base-content/50 cursor-pointer"
                                            ></i>
                                        </button>
                                    @endif
                                </div>
                            ...
                            @if($isEditor)
                                ...
                                <div
                                    ...
                                    x-show="occEditOpen"
                                    id="occeditdiv-{{ $occid }}"
                                    class="mt-4 space-y-4 rounded border p-4"
                                >
                                    ...
                                    <form
                                        method="POST"
                                        action="{{ $postAction }}"
                                        onsubmit="return window.confirm('{{ __('exsiccati.SURE_DEL_SPEC_LINK') }}');"
                                    >
                                        @csrf
                                        <input type="hidden" name="ometid" value="{{ $currentOmetid }}" />
                                        <input type="hidden" name="omenid" value="{{ $omenid }}" />
                                    ...
                                    <form
                                        method="POST"
                                        action="{{ $postAction }}"
                                        onsubmit="return verifyOccTransferForm(this);"
                                        class="space-y-3"
                                    >
                                        @csrf
                                        <input type="hidden" name="ometid" value="{{ $currentOmetid }}" />
                                        ...
                                        <div>
                                            <label
                                                ...
                                                >{{ __('exsiccati.TARGET_EXS_NUM') }}</label
                                            >
                                            <input
                                                name="targetexsnumber"
                                                type="text"
                                                class="mt-1 w-full max-w-[180px] rounded border px-3 py-2"
                                            />
                                        </div>
