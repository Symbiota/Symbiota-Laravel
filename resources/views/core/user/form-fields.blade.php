...
@if($include_passwords)
    ...
    <x-input required label="Password Confirmation" id="password_confirmation" type="password" />
@endif

<x-checkbox id="accessibilityPref" :label="__('profile_newprofile.ACCESSIBILITY_PREF')" :checked="$accessibilityPref" />
<label for="accessibilityPref"> {{ __('profile_newprofile.ACCESSIBILITY_PREF_DESC') }} </label>
